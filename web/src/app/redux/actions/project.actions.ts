...
export const ProjectActions = {
    ...
    UPDATE_PROJECT_REQUEST: '[project] update_sprint_request',
    UPDATE_PROJECT_SUCCESS: '[project] update_sprint_success',
    UPDATE_PROJECT_FAILURE: '[project] update_sprint_failure',
